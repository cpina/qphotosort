...
#
# Created: Sat Dec  2 12:02:58 2006
...
class Ui_about(object):
    def setupUi(self, about):
        ...
        about.resize(QtCore.QSize(QtCore.QRect(0,0,410,340).size()).expandedTo(about.minimumSizeHint()))
        ...
        self.Ok.setIcon(QtGui.QIcon(":/icons/close.png"))
        ...
        self.versio.setGeometry(QtCore.QRect(130,30,71,20))
        self.versio.setTextFormat(QtCore.Qt.AutoText)
        self.versio.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
